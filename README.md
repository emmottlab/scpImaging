...
# scpImaging
Package for curation, analysis and visualisation of cellenONE-based microscopy data, for example in single-cell proteomics experiments. This package offers capabilities to integrate with Cellpose and Cellprofiler analyst workflows, enabling multiplet detection and cell phenotyping.
...
While designed with single-cell proteomics (SCP) in mind, it should be compatable with any cellenONE-based single-cell data.
